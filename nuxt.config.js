  ...
  head: {
    ...
    meta: [{
      ...
      },
      {
        hid: 'description',
        name: 'description',
        content: "Powered by ASUS s'adresse à ceux qui acceptent uniquement la perfection. Nos équipes de recherche et développement à la renommée mondiale sont entièrement dévouées à notre devise : à la recherche de l'exceptionnel. Notre recherche constante de la perfection est récompensée par plus de 3000 prix chaque année."
      },
      {
      ...
      },
      {
        hid: 'og:url',
        property: 'og:url',
        content: "https://www.asus.fr/event/Powered-by-ASUS/"
      },
      {
        hid: 'og:title',
        property: 'og:title',
        content: "Powered By ASUS - Dominez avec le meilleur"
      },
      {
        hid: 'og:description',
